...
let sortedemp = arrangeEmpDetails1(empDetails)
...
function getAppraisalPct1(maxappraisalscore) {
    ...
    const promise = new Promise((resolve, reject) => {
        switch (true) {
            case maxappraisalscore === undefined:
                reject('Unfortunately, you are notr eligible for a hike')
                break

            case maxappraisalscore < 85:
                reject('Unfortunately, you are not eligible for a hike')
                break

            case maxappraisalscore >= 100:
                resolve('20% hike to be given')
                break

            case maxappraisalscore > 90 && maxappraisalscore < 100:
                resolve('10% hike to be given')
                break

            case maxappraisalscore > 85 && maxappraisalscore <= 90:
